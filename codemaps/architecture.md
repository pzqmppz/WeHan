...
| **技术平台** | 扣子智能体 + 豆包 | Next.js + Ant Design |
| **开发模式** | 低代码配置为主 | 代码开发为主 |
...
| 任务 | 负责端 | 交付物 |
|-----|-------|-------|
| 数据库 Schema 完善 | B 端 | Prisma schema |
| NextAuth.js 认证 | B 端 | 4 角色登录 |
| 路由守卫中间件 | B 端 | 权限拦截 |
| 求职 Agent 创建 | C 端 | 扣子智能体 |
| 开场白 + 基础对话 | C 端 | 可对话智能体 |
...
| 开放 API /api/open/jobs | B 端 | C 端可调用 |
| 实时语音集成 | C 端 | 语音对话功能 |
| 面试模拟工作流 | C 端 | 完整面试流程 |
...
*文档版本: 1.2 | 更新时间: 2026-02-27 | 变更: 添加数据库环境配置章节*
