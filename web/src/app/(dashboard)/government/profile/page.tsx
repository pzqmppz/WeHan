...
import {
  Card, Form, Input, Button, Spin, Typography, Row, Col, Avatar, Divider
} from 'antd'
import {
...
export default function GovernmentProfilePage() {
  ...
  if (status === 'unauthenticated') {
    router.push('/login?callbackUrl=/government/profile')
    return null
  }
          ...
          <Card title="账户信息" className="mb-4">
            ...
            >
              ...
              <Form.Item label="邮箱">
                ...
                />
                <Text type="secondary" className="text-xs">政府邮箱不可修改</Text>
              </Form.Item>
        ...
        <Col xs={24} lg={12}>
          <Card title="账户信息" className="mb-4">
            <div className="text-center mb-6">
              ...
              />
              <Title level={4} className="!mb-2">{profile?.name || session?.user?.name || '政府用户'}</Title>
              <Text type="secondary">政府管理员</Text>
            </div>
